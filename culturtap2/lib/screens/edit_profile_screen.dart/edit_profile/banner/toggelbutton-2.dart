...
// ================================
 ...
 class toggel2 extends StatefulWidget {
  const toggel2({super.key});

  @override
  State<toggel2> createState() => _toggel2State();
}

class _toggel2State extends State<toggel2> {
  ...
  Widget build(BuildContext context) {
    ...
    child: Column(children: [
      ...
      Image.asset( "assets/img/banner/b2.png", ),
