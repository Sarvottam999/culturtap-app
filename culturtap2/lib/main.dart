...
import 'package:culturtap/screens/ping_tabbar/pings/tab_bar.dart';
...
import 'package:culturtap/screens/searched_user/search_user.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    MultiProvider(
     ...
     ChangeNotifierProvider(create: (context) => schedule_call_provider(),),
     ChangeNotifierProvider(create: (context) => list_user_provider(),),
     ChangeNotifierProvider(create: (context) => remote_user_provider(),)
     ...
     child: MaterialApp(
      ...
      // ProviderFormPage(),
        ...
        routes: {
          ...
          s_1_schedule_intr_call.namedRoute :(context) => s_1_schedule_intr_call(),
